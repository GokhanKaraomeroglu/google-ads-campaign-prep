...
const GeminiResponse = ({ geminiResponse, setResponseGemini }) => {
  const clearResponse = () => {
    setResponseGemini("");
  };
  const saveAsPdf = () => {
    ...
    const text = geminiResponse || "Can't get the response. Try again please.";
    ...
    <div className="col-md-4 d-flex">
      ...
      >
        ...
        <pre style={{ whiteSpace: "pre-wrap", wordWrap: "break-word", flex: 1 }}>
          {geminiResponse || "Response from Gemini will appear here."}
        </pre>
