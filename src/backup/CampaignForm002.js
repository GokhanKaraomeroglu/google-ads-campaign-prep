...
const CampaignForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (demands.visualRequest) {
      ...
      products.forEach((product, index) => {
        visualRequestDocument += `b. Product Images (for Product-${index + 1})\n`;
    ...
    const requestData = {
      ...
      campaign: campaignInfo,
      products,
      textdemands: `To create the texts in the campaign, you need to prepare in English, ${demands.headlines30} 30-character Headlines, ${demands.headlines90} 90-character Long Headlines, ${demands.descriptions60} 60-character Descriptions, ${demands.descriptions90} 90-character Descriptions, ${demands.searchTerms} Search Terms`,
      imagedemands: `To create the visual assets in the campaign, you need to prepare a Visual Request Document. The Format of the document is blow. You must fill in all fields of document as required. \n ${visualRequestDocument}`,
    };
    ...
    try {
      const apiResponse = await axios.post('https://api.openai.com/v1/chat/completions', {
        ...
        messages: [
          ...
          { role: 'user', content: JSON.stringify(requestData) }, // Tek bir kullanıcı isteği
        ]
      }, {
        headers: {
  ...
  return (
    <div className="container mt-5">
      <h2 className="text-center mb-4">Google Ads Campaign Preparation Form</h2>
      <form onSubmit={handleSubmit} className="shadow p-4 bg-light rounded">
        ...
        <div className="mb-3">
          ...
          />{" "}
          <label>Number of 30 Character Headlines:</label>
          <input
            type="number"
            name="headlines30"
        ...
        <div className="mb-3">
          <input
            ...
            onChange={handleDemandChange}
          />{" "}
          <label>Number of 90 Character Long Headlines:</label>
          <input
            type="number"
            name="headlines90"
        ...
        <div className="mb-3">
          <input
            ...
            onChange={handleDemandChange}
          />{" "}
          <label>Number of 60 Character Descriptions:</label>
          <input
            type="number"
            name="descriptions60"
        ...
        <div className="mb-3">
          <input
            ...
            onChange={handleDemandChange}
          />{" "}
          <label>Number of 90 Character Descriptions:</label>
          <input
            type="number"
            name="descriptions90"
        ...
        <div className="mb-3">
          <input
            ...
            onChange={handleDemandChange}
          />{" "}
          <label>Number of Search Terms:</label>
          <input
            type="number"
            name="searchTerms"
        ...
        <div className="mb-3">
          <input
            ...
            onChange={handleDemandChange}
          />{" "}
          <label>Visual Request Document</label>
        </div>
